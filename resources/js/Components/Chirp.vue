        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id">
                    ...
                    <template #content>
                        <button class="block w-full px-4 py-2 text-left text-sm
                             leading-5 text-gray-700 hover:bg-gray-100 focus:big-gray-100
            ...
            <form
                ...
                <textarea
                    ...
                    class="mt-4 w-full text-gray-900 border-gray-300 focus:border-indigo-300
